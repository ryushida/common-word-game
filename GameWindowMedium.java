 ...
 * Period 3
 * 
 * The Medium Game window for the guessing game
 */

public class GameWindowMedium extends GameWindow {

	// The buttons used in the frame
	private JButton thirdWordB, fourthWordB;
	...
	public GameWindowMedium(int numberOfRounds) throws FileNotFoundException {
